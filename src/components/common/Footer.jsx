...
const Footer = () => {
  return (
    <footer className="px-4 divide-y dark:bg-gray-950 dark:text-gray-100">
      <div className="w-11/12 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-2/3">
          ...
          >
            ...
            <span className="self-center text-4xl font-akaya text-blue-700 dark:text-blue-400 font-semibold">
              CarftoPia
            </span>
          </a>
